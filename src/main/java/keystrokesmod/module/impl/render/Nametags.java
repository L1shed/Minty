...
public class Nametags extends Module {
   ...
   public static ButtonSetting rm;
   ...
   public Nametags() {
      ...
      this.registerSetting(b = new ButtonSetting("Rect", true));
      this.registerSetting(c = new ButtonSetting("Show health", true));
      this.registerSetting(d = new ButtonSetting("Show invis", true));
      this.registerSetting(rm = new ButtonSetting("Remove tags", false));
   }
      ...
      if (rm.isToggled()) {
         ...
         if (e.entity instanceof EntityPlayer && e.entity != mc.thePlayer && e.entity.deathTime == 0) {
            ...
            if (c.isToggled()) {
               ...
               String h = (r < 0.3D ? "§c" : (r < 0.5D ? "§6" : (r < 0.7D ? "§e" : "§a"))) + Utils.rnd((double)en.getHealth(), 1);
               str = str + " " + h;
            }
